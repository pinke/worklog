...
<p>
<div align="center">
<form method="post" action="<?php echo $g_worklog_add ?>">
...
<tr>
	...
	<td width="75%">
		<input type="text" name="subject" size="80" maxlength="255" value="<?php echo $f_subject ?>">
	</td>
</tr>
<tr class="row-2">
	<td class="category">
	...
	<td>
		<textarea name="content" cols="80" rows="10" wrap="virtual" value="<?php echo $f_content ?>"></textarea>
	</td>
</tr>
	...
	<td>
		<select name="worklog_view_level">
