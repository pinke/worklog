...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="60%">
		<?php echo plugin_lang_get( 'worklog_view_window' ) ?>
	</td>
	<td class="center" width="20%">
		<label><input type="radio" name="worklog_view_window" value="1" <?php echo ( ON == plugin_config_get( 'worklog_view_window' ) ) ? 'checked="checked" ' : ''?>/>
			<?php echo plugin_lang_get( 'plugin_format_enabled' ) ?></label>
	</td>
	<td class="center" width="20%">
		<label><input type="radio" name="worklog_view_window" value="0" <?php echo ( OFF == plugin_config_get( 'worklog_view_window' ) ) ? 'checked="checked" ' : ''?>/>
			<?php echo plugin_lang_get( 'plugin_format_disabled' ) ?></label>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category" width="60%">
		<?php echo plugin_lang_get( 'worklog_view_check' ) ?>
	</td>
	<td class="center" width="20%">
		<label><input type="radio" name="worklog_view_check" value="1" <?php echo ( ON == plugin_config_get( 'worklog_view_check' ) ) ? 'checked="checked" ' : ''?>/>
			<?php echo plugin_lang_get( 'plugin_format_enabled' ) ?></label>
	</td>
	<td class="center" width="20%">
		<label><input type="radio" name="worklog_view_check" value="0" <?php echo ( OFF == plugin_config_get( 'worklog_view_check' ) ) ? 'checked="checked" ' : ''?>/>
			<?php echo plugin_lang_get( 'plugin_format_disabled' ) ?></label>
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
